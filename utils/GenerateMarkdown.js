...
function renderLicenseBadge(license) {
  ...
  switch (license) {
    ...
    case 'Mozilla':
      badge +=
        ': MPL 2.0](https://img.shields.io/badge/License-MPL_2.0-brightgreen.svg)](https://opensource.org/licenses/MPL-2.0)';
      break;
...
function renderLicenseLink(license) {
  ...
  switch (license) {
    ...
    case 'Unlicense':
      licenseLink =
        'This is free and unencumbered public domain software. For more information, see [https://unlicense.org/](https://unlicense.org/) or the accompanying [file](./LICENSE).';
      break;
